import { Button, Heading, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Select } from "@chakra-ui/react";
import { useRef, useState } from "react";
import { EmailHookCreator } from "./HookCreators";

export const CreateHookModal = ({ isOpen, onClose: closeModal }) => {
